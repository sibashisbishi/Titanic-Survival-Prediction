...
sbn.barplot(x="Sex", y="Survived", data=train)#sbn.barplot(x="Pclass", y="Survived", data=train)
plt.show()
...
output.to_csv('submission.csv', index=False) #index=false means no row heading
